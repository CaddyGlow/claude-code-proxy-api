import type { AnalyticsResponse, MetricsStreamEvent } from '../../src/lib/types/metrics';
...
export const mockAnalyticsData: AnalyticsResponse = {
	...
	model_stats: [
		{ model: 'claude-3-sonnet-20240229', request_count: 800, avg_response_time: 1.2, total_cost: 8.5 },
		{ model: 'claude-3-opus-20240229', request_count: 450, avg_response_time: 1.3, total_cost: 4.0 },
		{ model: 'claude-3-haiku-20240307', request_count: 200, avg_response_time: 0.8, total_cost: 1.2 }
	],
	service_breakdown: [
		{
...
export const testDataVariants = {
	...
	singleModel: {
		...mockAnalyticsData,
		model_stats: [
			{ model: 'claude-3-sonnet-20240229', request_count: 1250, avg_response_time: 1.25, total_cost: 12.5432 }
		]
	},
