...
from ccproxy.cli.commands.serve import claude
...
class TestClaudeCommand:
    ...
    @patch("ccproxy.cli.commands.serve.os.execvp")
    ...
    def test_claude_no_args(self, mock_config_manager, mock_settings):
        ...
        with patch("ccproxy.cli.commands.serve.os.execvp") as mock_execvp:
            runner = CliRunner()
    ...
    @patch("ccproxy.cli.commands.serve.config_manager")
    @patch("ccproxy.cli.commands.serve.Path.is_absolute")
    @patch("ccproxy.cli.commands.serve.Path.resolve")
    @patch("ccproxy.cli.commands.serve.os.execvp")
